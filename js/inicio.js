...
function PaginaInicio() {
  ...
  useEffect(() => {
    ...
    fetch(API_HABITACIONES + "?estado=disponible&limit=3")
      ...
      .catch(() => {
        window.QDToast &&
          window.QDToast.aviso(
            "No se pudieron cargar las habitaciones destacadas.",
          );
      })
    ...
    <div>
      ...
      <div className="hero-react">
        ...
        <p className="hero-react__desc">
          Tu refugio perfecto te espera en Hotel Quinta Dalam. Tradición,
          confort, y un servicio excepcional diseñado para crear recuerdos
          inolvidables.
        </p>
        <div className="hero-react__botones">
          <a href="reservaciones.html#paso-1" className="btn-hero-primario">
            Reservar Ahora
          </a>
          <a href="catalogo.html" className="btn-hero-secundario">
            Ver Habitaciones
          </a>
        </div>
        ...
        <form className="buscador-form" onSubmit={manejarBusqueda}>
          <div className="buscador-campo">
            ...
            <input
              ...
              onChange={(e) =>
                setBusqueda({ ...busqueda, checkIn: e.target.value })
              }
            />
          </div>
          <div className="buscador-campo">
            ...
            <input
              type="date"
              required
              min={busqueda.checkIn || fechaHoy}
              value={busqueda.checkOut}
              onChange={(e) =>
                setBusqueda({ ...busqueda, checkOut: e.target.value })
              }
            />
          </div>
          <div className="buscador-campo">
            ...
            <select
              ...
              onChange={(e) =>
                setBusqueda({ ...busqueda, huespedes: e.target.value })
              }
            >
              {[1, 2, 3, 4, 5].map((n) => (
      ...
      <div className="destacadas-seccion">
        <div className="destacadas-seccion__header">
          <h2 className="destacadas-seccion__titulo">
            Habitaciones Destacadas
          </h2>
          <p className="destacadas-seccion__desc">
            Nuestras opciones más populares elegidas por los huéspedes.
          </p>
        </div>
              ...
              <div key={hab.id} className="hab-card">
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://via.placeholder.com/400x250/e0d5c1/8c5a35?text=Habitación";
                    }}
                  />
                  <span className="hab-badge hab-badge--tipo">{hab.tipo}</span>
                  <span className="hab-badge hab-badge--estado hab-badge--disponible">
                    ✨ Destacada
                  </span>
                ...
                <div className="hab-card__body">
                  ...
                  <div className="hab-card__resena">
                    <div className="hab-resena__stars">
                      {estrell(hab.resena.estrellas)}
                    </div>
                    <p className="hab-resena__texto">
                      "{hab.resena.comentario}"
                    </p>
        ...
        <div style={{ textAlign: "center", marginTop: "32px" }}>
          <a
            ...
            style={{
              ...
              fontSize: "0.88rem",
              boxShadow: "0 4px 16px rgba(140,90,53,0.3)",
        ...
        <div className="servicios-seccion__inner">
          ...
          <div className="servicios-grid">
            {[
              {
                icono: "🏺",
                titulo: "Arte Purépecha",
                desc: "Cada habitación está decorada con artesanías y textiles auténticos de Michoacán.",
              },
              {
                icono: "🍽️",
                titulo: "Cocina Tradicional",
                desc: "Sabores únicos de la gastronomía michoacana preparados con ingredientes locales.",
              },
              {
                icono: "🌿",
                titulo: "Entorno Natural",
                desc: "Rodeados de naturaleza, en un ambiente tranquilo ideal para el descanso.",
              },
              {
                icono: "⭐",
                titulo: "Servicio Premium",
                desc: "Atención personalizada para que tu estancia sea verdaderamente memorable.",
              },
            ].map((s, i) => (
      ...
      <div className="resenas-seccion">
        <h2 className="resenas-seccion__titulo">
        ...
        <div className="resenas-grid">
          {[
            {
              texto:
                "Una experiencia mágica. La decoración artesanal es preciosa y el servicio excepcional.",
              autor: "María G.",
              tipo: "Habitación Tzintzuntzan",
              iniciales: "MG",
            },
            {
              texto:
                "Increíble para nuestra luna de miel. El jacuzzi privado y el servicio de primera clase nos encantaron.",
              autor: "Roberto V.",
              tipo: "Suite Quinceo",
              iniciales: "RV",
            },
            {
              texto:
                "Perfecta para toda la familia. Muy acogedora y el personal siempre atento a todo.",
              autor: "Luis F.",
              tipo: "Habitación Tacámbaro",
              iniciales: "LF",
            },
          ].map((r, i) => (
        ...
        <div className="ubicacion-seccion__inner">
          <div className="ubicacion-seccion__texto">
            ...
            <p className="ubicacion-seccion__desc">
              Ubicados en el corazón de Michoacán, a pocos minutos de los
              principales Pueblos Mágicos y atractivos turísticos de la región.
            </p>
      ...
      <div className="cta-final-wrap">
        <div className="cta-final-box">
          ...
          <p className="cta-final-box__desc">
            Reserva ahora y disfruta de una estancia única en el corazón de
            Michoacán. Habitaciones disponibles para tus próximas fechas.
          </p>
