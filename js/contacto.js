...
function ModuloContacto() {
  ...
  function validar() {
    ...
    else if (datos.nombre.trim().length < 3) e.nombre = "Mínimo 3 caracteres.";
    ...
    if (!datos.mensaje.trim()) e.mensaje = "El mensaje es obligatorio.";
  ...
  function validarTodo(d) {
    ...
    else if (!/^[A-Za-záéíóúÁÉÍÓÚñÑ\s]+$/.test(d.nombre.trim()))
    ...
    else if (!/^[0-9]{10}$/.test(d.telefono.trim()))
    ...
    <div className="contacto-page">
      ...
      <div className="contacto-hero">
        <div className="contacto-hero-card">
          ...
          <p>
            Estamos listos para hacer de tu visita a Michoacán algo inolvidable.
      ...
      <div className="contacto-card">
        ...
        <div className="contacto-panel-info">
          ...
          <p className="cinfo-subtitle">
            Llena el formulario y nuestro equipo
            <br />
        ...
        <div className="contacto-panel-form">
          ...
          <form onSubmit={procesarEnvio} noValidate>
            ...
            <div className="cform-row-2">
              <div className="cform-group">
                ...
                <div className="cform-input-wrap">
                  ...
                  />
                  <span className="cform-input-icon">
                    <IconUser />
                  </span>
                </div>
                {errores.nombre && (
                  <p className="cform-field-error">⚠ {errores.nombre}</p>
                )}
              </div>
              ...
              <div className="cform-group">
                ...
                {errores.telefono && (
                  <p className="cform-field-error">⚠ {errores.telefono}</p>
                )}
              </div>
            </div>
            ...
            <div className="cform-group">
              ...
              {errores.correo && (
                <p className="cform-field-error">⚠ {errores.correo}</p>
              )}
            </div>
            ...
            <div className="cform-group">
              ...
              <div className="cform-input-wrap">
                ...
                >
                  ...
                  <option value="Dudas sobre Habitaciones">
                    Dudas sobre Habitaciones
                  </option>
                  <option value="Eventos Especiales">
                    Eventos Especiales (Bodas, Convenciones)
                  </option>
              ...
              <div className="cform-input-wrap">
                <textarea
                  ...
                  onChange={(e) => {
                    ...
                    setErrores((p) => ({ ...p, mensaje: null }));
                  }}
                  onBlur={(e) => validarCampo("mensaje", e.target.value)}
                />
                <span className="cform-input-icon top">
                  <IconMessage />
                </span>
              </div>
              {errores.mensaje && (
                <p className="cform-field-error">⚠ {errores.mensaje}</p>
              )}
              <p
                style={{
      ...
      {mensajeEnviado && (
        <div className="cform-modal-overlay">
          <div className="cform-modal">
            ...
            <p>
              Hemos recibido tu mensaje sobre <strong>"{datos.asunto}"</strong>.
              <br />
...
const contactoRoot = ReactDOM.createRoot(
  document.getElementById("root-contacto"),
);
